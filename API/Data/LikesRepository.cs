...
namespace API.Data
{
    public class LikesRepository : ILikesRepository
    {
        ...
        // Return the list of users that the current logged in user has liked when predicate = 'liked'
        // Return the list of users that have liked the current logged in user when prediacte = 'likedBy'
